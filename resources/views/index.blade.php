   ...
   <div id="owl-carousel-1" class="owl-carousel owl-theme center-owl-nav">
			...
			<article class="article thumb-article">
				<div class="article-img">
					<img src="/images/img-lg-1.jpg" alt="">
				</div>
			...
			<article class="article thumb-article">
				<div class="article-img">
					<img src="/images/img-lg-2.jpg" alt="">
				</div>
				<div class="article-body">
					<ul class="article-info">
						<li class="article-category"><a href="#">News</a></li>
			...
			<article class="article thumb-article">
				<div class="article-img">
					<img src="/images/img-lg-3.jpg" alt="">
				</div>
				<div class="article-body">
					<ul class="article-info">
						<li class="article-category"><a href="#">News</a></li>
								...
								<div class="row">
									...
									<div class="col-md-3 col-sm-6">
										...
										<article class="article">
											...
											<div class="article-body">
												<h4 class="article-title"><a href="#">{{$information->title}}</a></h4>
												<ul class="article-meta">
													<li><i class="fa fa-clock-o"></i>{{$information->time}}</li>
													<li><i class="fa fa-comments"></i> 33</li>
												</ul>
											</div>
										</article>
								...
								<div class="row">
									...
									<div class="col-md-4 col-sm-6">
										...
										<article class="article widget-article">
											<div class="article-img">
												<a href="#">
													<img src="/images/img-widget-1.jpg" alt="">
												</a>
											</div>
											<div class="article-body">
										...
										<article class="article widget-article">
											<div class="article-img">
												<a href="#">
													<img src="/images/img-widget-2.jpg" alt="">
												</a>
											</div>
											<div class="article-body">
												<h4 class="article-title"><a href="#">Duis urbanitas eam in, tempor consequat.</a></h4>
									...
									<div class="col-md-4 col-sm-6">
										...
										<article class="article widget-article">
											<div class="article-img">
												<a href="#">
													<img src="/images/img-widget-3.jpg" alt="">
												</a>
											</div>
											<div class="article-body">
												<h4 class="article-title"><a href="#">Duis urbanitas eam in, tempor consequat.</a></h4>
										...
										<article class="article widget-article">
											<div class="article-img">
												<a href="#">
													<img src="/images/img-widget-4.jpg" alt="">
												</a>
											</div>
											<div class="article-body">
												<h4 class="article-title"><a href="#">Duis urbanitas eam in, tempor consequat.</a></h4>
									...
									<div class="col-md-4 hidden-sm">
										...
										<article class="article widget-article">
											<div class="article-img">
												<a href="#">
													<img src="/images/img-widget-5.jpg" alt="">
												</a>
											</div>
											<div class="article-body">
												<h4 class="article-title"><a href="#">Duis urbanitas eam in, tempor consequat.</a></h4>
										...
										<article class="article widget-article">
											<div class="article-img">
												<a href="#">
													<img src="/images/img-widget-6.jpg" alt="">
												</a>
											</div>
											<div class="article-body">
												<h4 class="article-title"><a href="#">Duis urbanitas eam in, tempor consequat.</a></h4>
				...
				<div class="row">
						...
						<div class="row">
							...
							<div class="col-md-6 col-sm-6">
								...
								<article class="article">
									<div class="article-img">
										<a href="#">
											<img src="/images/img-sm-1.jpg" alt="">
										</a>
										<ul class="article-info">
											<li class="article-type"><i class="fa fa-camera"></i></li>
										</ul>
								...
								<article class="article widget-article">
									<div class="article-img">
										<a href="#">
											<img src="/images/img-widget-7.jpg" alt="">
										</a>
									</div>
									<div class="article-body">
										<h4 class="article-title"><a href="#">Duis urbanitas eam in, tempor consequat.</a></h4>
								...
								<article class="article widget-article">
									<div class="article-img">
										<a href="#">
											<img src="/images/img-widget-8.jpg" alt="">
										</a>
									</div>
									<div class="article-body">
										<h4 class="article-title"><a href="#">Duis urbanitas eam in, tempor consequat.</a></h4>
							...
							<div class="col-md-6 col-sm-6">
								...
								<article class="article">
									<div class="article-img">
										<a href="#">
											<img src="/images/img-sm-2.jpg" alt="">
										</a>
										<ul class="article-info">
											<li class="article-type"><i class="fa fa-file-text"></i></li>
										</ul>
								...
								<article class="article widget-article">
									<div class="article-img">
										<a href="#">
											<img src="/images/img-widget-9.jpg" alt="">
										</a>
									</div>
									<div class="article-body">
										<h4 class="article-title"><a href="#">Duis urbanitas eam in, tempor consequat.</a></h4>
								...
								<article class="article widget-article">
									<div class="article-img">
										<a href="#">
											<img src="/images/img-widget-10.jpg" alt="">
										</a>
									</div>
									<div class="article-body">
										<h4 class="article-title"><a href="#">Duis urbanitas eam in, tempor consequat.</a></h4>
						...
						<div class="row">
							...
							<div class="col-md-6 col-sm-6">
								...
								<article class="article">
									<div class="article-img">
										<a href="#">
											<img src="/images/img-sm-3.jpg" alt="">
										</a>
										<ul class="article-info">
											<li class="article-type"><i class="fa fa-camera"></i></li>
										</ul>
							...
							<div class="col-md-6 col-sm-6">
								...
								<article class="article">
									<div class="article-img">
										<a href="#">
											<img src="/images/img-sm-4.jpg" alt="">
										</a>
										<ul class="article-info">
											<li class="article-type"><i class="fa fa-camera"></i></li>
										</ul>
						...
						<div class="row">
							...
							<div class="col-md-4 col-sm-4">
								...
								<article class="article">
									<div class="article-img">
										<a href="#">
											<img src="/images/img-md-1.jpg" alt="">
										</a>
										<ul class="article-info">
											<li class="article-type"><i class="fa fa-file-text"></i></li>
										</ul>
							...
							<div class="col-md-4 col-sm-4">
								...
								<article class="article">
									<div class="article-img">
										<a href="#">
											<img src="/images/img-md-2.jpg" alt="">
										</a>
										<ul class="article-info">
											<li class="article-type"><i class="fa fa-file-text"></i></li>
										</ul>
							...
							<div class="col-md-4 col-sm-4">
								...
								<article class="article">
									<div class="article-img">
										<a href="#">
											<img src="/images/img-md-3.jpg" alt="">
										</a>
										<ul class="article-info">
											<li class="article-type"><i class="fa fa-file-text"></i></li>
										</ul>
					...
					<div class="col-md-4">
						...
						<div class="widget center-block hidden-xs">
							<img class="center-block" src="/images/ad-1.jpg" alt=""> 
						</div>
						<!-- /Ad widget -->
						...
						<div class="widget">
							...
							<div id="owl-carousel-3" class="owl-carousel owl-theme center-owl-nav">
								...
								<article class="article">
									<div class="article-img">
										<a href="#">
											<img src="/images/img-md-4.jpg" alt="">
										</a>
										<ul class="article-info">
											<li class="article-type"><i class="fa fa-file-text"></i></li>
										</ul>
		...
		<div class="visible-lg visible-md">
			<img class="center-block" src="/images/ad-3.jpg" alt="">
		</div>
		<!-- /AD SECTION -->
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<div id="owl-carousel-2" class="owl-carousel owl-theme">
							...
							<article class="article thumb-article">
								<div class="article-img">
									<img src="/images/img-thumb-1.jpg" alt="">
								</div>
								<div class="article-body">
									<ul class="article-info">
										<li class="article-category"><a href="#">News</a></li>
							...
							<article class="article thumb-article">
								<div class="article-img">
									<img src="/images/img-thumb-2.jpg" alt="">
								</div>
								<div class="article-body">
									<ul class="article-info">
										<li class="article-category"><a href="#">News</a></li>
							...
							<article class="article thumb-article">
								<div class="article-img">
									<img src="/images/img-thumb-3.jpg" alt="">
								</div>
								<div class="article-body">
									<ul class="article-info">
										<li class="article-category"><a href="#">News</a></li>
							...
							<article class="article thumb-article">
								<div class="article-img">
									<img src="/images/img-thumb-4.jpg" alt="">
								</div>
								<div class="article-body">
									<ul class="article-info">
										<li class="article-category"><a href="#">News</a></li>
					...
					<div class="col-md-4">
						...
						<div class="widget">
							...
							<div id="owl-carousel-4" class="owl-carousel owl-theme">
								...
								<article class="article thumb-article">
									<div class="article-img">
										<img src="/images/images/img-thumb-2.jpg" alt="">
									</div>
									<div class="article-body">
										<ul class="article-info">
											<li class="article-category"><a href="#">News</a></li>
						...
						<div class="widget galery-widget">
							...
							<ul>
								<li><a href="#"><img src="/images/img-widget-3.jpg" alt=""></a></li>
								<li><a href="#"><img src="/images/img-widget-4.jpg" alt=""></a></li>
								<li><a href="#"><img src="/images/img-widget-5.jpg" alt=""></a></li>
								<li><a href="#"><img src="/images/img-widget-6.jpg" alt=""></a></li>
								<li><a href="#"><img src="/images/img-widget-7.jpg" alt=""></a></li>
								<li><a href="#"><img src="/images/img-widget-8.jpg" alt=""></a></li>
								<li><a href="#"><img src="/images/img-widget-9.jpg" alt=""></a></li>
								<li><a href="#"><img src="/images/img-widget-10.jpg" alt=""></a></li>
							</ul>
						</div>
						<!-- /galery widget -->
